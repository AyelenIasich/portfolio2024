...
function Home() {
  ...
  return (
    <section className="home-section">
      ...
      <div className="container d-flex  align-items-center justify-content-center container-home-content ">
        <div className="row content-row ">
          <div className="col-12 col-lg-6 pt-xl-5 mt-xl-2 mt-xxl-0 align-self-center justify-content-center order-2 text-content col-home ">
            ...
            <div className="button-group pb-3 d-flex d-md-block justify-content-center justify-md-content-start ">
              <SecondaryBtn
                ...
                isContactBtn={true}
                customIcon={<TbLayoutGrid />}
                extraStyle={"me-2 me-md-4 mb-3 mb-md-0 mt-3 mt-lg-2 mt-xxl-4 "}
              />
              <PrimaryBtn
                label={t("DownloadCV")}
                onClick={handleDownload}
                extraStyle={"mt-3 mt-lg-2 mt-xxl-4"}
              />
            </div>
          </div>
